...
INSERT INTO `tb_resource` VALUES ('3', 'perms[user:save],authc', '', '3', '创建用户', '2', '/account/user/save/**', '2', '');
INSERT INTO `tb_resource` VALUES ('4', 'perms[user:delete],authc', '', '4', '删除用户', '2', '/account/user/delete/**', '2', '');
INSERT INTO `tb_resource` VALUES ('5', 'perms[user:edit],authc', '', '5', '编辑用户', '2', '/account/user/edit/**', '2', '');
INSERT INTO `tb_resource` VALUES ('6', 'perms[group:list]', '', '6', '组管理', '1', '/account/group/list/**', '1', 'glyphicon glyphicon-briefcase');
INSERT INTO `tb_resource` VALUES ('7', 'perms[group:save],authc', '', '7', '创建和编辑组', '2', '/account/group/save/**', '6', '');
INSERT INTO `tb_resource` VALUES ('8', 'perms[group:edit],authc', '', '8', '编辑组', '2', '/account/group/edit/**', '6', '');
INSERT INTO `tb_resource` VALUES ('9', 'perms[group:delete],authc', '', '9', '删除组', '2', '/account/group/delete/**', '6', '');
INSERT INTO `tb_resource` VALUES ('10', 'perms[resource:list]', '', '10', '资源管理', '1', '/account/resource/list/**', '1', 'glyphicon glyphicon-link');
INSERT INTO `tb_resource` VALUES ('11', 'perms[resource:save],authc', '', '11', '创建和编辑资源', '2', '/account/resource/save/**', '10', '');
INSERT INTO `tb_resource` VALUES ('12', 'perms[resource:edit],authc', '', '12', '编辑资源', '2', '/account/resource/edit/**', '10', '');
INSERT INTO `tb_resource` VALUES ('13', 'perms[resource:delete],authc', '', '13', '删除资源', '2', '/account/resource/delete/**', '10', '');
INSERT INTO `tb_resource` VALUES ('14', '', '', '14', '系统管理', '1', '', null, 'glyphicon glyphicon-cog');
INSERT INTO `tb_resource` VALUES ('15', 'perms[data-dictionary:list]', '', '15', '数据字典管理', '1', '/variable/data-dictionary/list/**', '14', 'glyphicon glyphicon-list-alt');
INSERT INTO `tb_resource` VALUES ('16', 'perms[data-dictionary:save],authc', '', '16', '创建和编辑数据字典', '2', '/variable/data-dictionary/save/**', '15', '');
INSERT INTO `tb_resource` VALUES ('17', 'perms[data-dictionary:edit],authc', '', '17', '编辑数据字典', '2', '/variable/data-dictionary/edit/**', '15', '');
INSERT INTO `tb_resource` VALUES ('18', 'perms[data-dictionary:delete],authc', '', '18', '删除数据字典', '2', '/variable/data-dictionary/delete/**', '15', '');
INSERT INTO `tb_resource` VALUES ('19', 'perms[dictionary-category:list]', '', '19', '字典类别管理', '1', '/variable/dictionary-category/list/**', '14', 'glyphicon glyphicon-folder-close');
INSERT INTO `tb_resource` VALUES ('20', 'perms[dictionary-category:save],authc', '', '20', '创建和编辑字典类别', '2', '/variable/dictionary-category/save/**', '19', '');
INSERT INTO `tb_resource` VALUES ('21', 'perms[dictionary-category:edit],authc', '', '21', '编辑字典类别', '2', '/variable/dictionary-category/edit/**', '19', '');
INSERT INTO `tb_resource` VALUES ('22', 'perms[dictionary-category:delete],authc', '', '22', '删除字典类别', '2', '/variable/dictionary-category/delete/**', '19', '');
