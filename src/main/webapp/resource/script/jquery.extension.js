(function($) {
	...
	$.extend(jQuery, {
				 ...
				 *            json 字符串
				 * @param useNative
				 *            是否使用浏览器常规的转换方式，true表示是，false表示不是，默认为:false
				 * 
				 * @returns Object
				 */
	...
	$.applyIf(Function.prototype, {
				...
				/**
				 * 通过arguments[0], arguments[1],
				 * arguments[2],创建一个callback方法来将参数传递到要执行的方法中
				 * 
				 * <pre>
				 * var sayHi = function(name) {
				 * 	alert('Hi, ' + name);
