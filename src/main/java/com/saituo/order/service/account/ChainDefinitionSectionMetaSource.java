...
/**
 * 借助 spring {@link org.springframework.beans.factory.FactoryBean} 对 apache
 * shiro 的 premission 进行动态创建
 */
public class ChainDefinitionSectionMetaSource implements FactoryBean<Section> {
	...
	public Section getObject() throws BeansException {
		...
		List<Map<String, Object>> resources = accountService.getMenus();
