...
public class JavaMailService {
	 ...
	 *            freemarker模板文件名
	 * @param attachment
	 *            附件，该附件为一个map，将key来做文件名，value来做文件的形式发送出去
	 * @param model
	 *            freemarker模板里要取值的el名称
	 * 
	 * @throws IOException
	 ...
	 * @throws TemplateException
	 */
	public String getTemplateString(String templateName, Map<String, ?> model) throws IOException, TemplateException {
