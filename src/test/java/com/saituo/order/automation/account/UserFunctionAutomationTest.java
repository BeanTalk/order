package com.saituo.order.automation.account;
...
import com.saituo.order.LaunchJetty;
import com.saituo.order.automation.AutomationTestCaseSupport;
...
public class UserFunctionAutomationTest extends AutomationTestCaseSupport{
    ...
    public void test() {
        ...
        //打开添加页面
        click(By.xpath("//a[@href='"+ LaunchJetty.DEFAULT_CONTEXT_PATH + "/account/user/edit']"));

        //填写表单
        input(By.xpath("//form[@id='edit-user-form']//input[@name='username']"), "admin");
        input(By.xpath("//form[@id='edit-user-form']//input[@name='nickname']"), "maurice.chen");
        input(By.xpath("//form[@id='edit-user-form']//input[@name='password']"), "123456");
        input(By.xpath("//form[@id='edit-user-form']//input[@name='confirmPassword']"), "123456");
        select(By.xpath("//form[@id='edit-user-form']//select[@name='state']")).selectByValue("1");
        input(By.xpath("//form[@id='edit-user-form']//input[@name='email']"), "es.chenxiaobo@gmail.com");
        ...
        // 设置最后的一个值
        input(By.xpath("//form[@id='edit-user-form']//input[@name='username']"), "test_user");
        // 验证通过，提交表单
        click(By.xpath("//div[@class='panel-footer']//button[@type='submit']"));
        ...
        // 填写表单
        input(By.xpath("//form[@id='edit-user-form']//input[@name='nickname']"), "modify");
        select(By.xpath("//form[@id='edit-user-form']//select[@name='state']")).selectByValue("2");
